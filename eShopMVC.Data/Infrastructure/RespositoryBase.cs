...
namespace eShopMVC.Data.Infrastructure
{
  public abstract class RespositoryBase<T> : IRespository<T> where T : class
    {
        private DBShopMVCContext dataContext;
       ...
       protected IDbFactory DbFactory
        ...
        protected DBShopMVCContext DbContext
        {
        ...
        public IEnumerable<T> GetAll(string[] includes = null)
        {
            ...
            return dataContext.Set<T>().AsQueryable();//Set<T> su dung de truy vabn va luu cac the hien Tentity
        }
